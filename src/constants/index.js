...
export const pricing = [
  {
    ...
    price: "5999",
    features: [
      { id: "0", name: "FB/Insta Post", imageUrl: "11" },
      { id: "1", name: "Caption Writing", imageUrl: "11" },
      { id: "2", name: "Page Management", imageUrl: checkmark },
      { id: "3", name: "Cover Poster", imageUrl: "1" },
      { id: "4", name: "Complimentary Reel", imageUrl: "1" },
      ...
      { id: "9", name: "Boosting(Your Call)", imageUrl: "Your call" },
    ],
  },
  {
    id: "1",
    ...
    price: "16,999",
    features: [
      { id: "0", name: "FB/Insta Post", imageUrl: "15" },
      { id: "1", name: "Caption Writing", imageUrl: "15" },
      { id: "2", name: "Page Management", imageUrl: checkmark },
      { id: "3", name: "Cover Poster", imageUrl: "Your call" },
      { id: "4", name: "Complimentary Reel", imageUrl: "1" },
  ...
  },
  {
    ...
    price: "26,999",
    features: [
      { id: "0", name: "FB/Insta Post", imageUrl: "20" },
      { id: "1", name: "Caption Writing", imageUrl: "20" },
      { id: "2", name: "Page Management", imageUrl: checkmark },
      { id: "3", name: "Cover Poster", imageUrl: "Your call" },
      { id: "4", name: "Complimentary Reel", imageUrl: "2" },
      { id: "5", name: "Monthly Reporting", imageUrl: checkmark },
      { id: "6", name: "Strategic Collaboration", imageUrl: checkmark },
      { id: "7", name: "Basic Page Automation", imageUrl: checkmark },
